...
String typeOfWork = request.getParameter("typeOfUser");
...
<html>
    ...
    <body>
        ...
        statement.executeUpdate("UPDATE ACTOR SET NAME='"+name+"', SURNAME='"+surname+"', AFM='"+afm+"'," +
            "TYPE='"+typeOfWork+"', HOMEADDRESS='"+haddress+"', BIRTHDAY='"+birth+"', SEX='"+sex+"'," +
            " FAMILYSTATUS='"+familyStatus+"' WHERE AFM='"+checkAfm+"';");

        %>
        Η ενημέρωση των στοιχείων του χρήστη ολοκληρώθηκε με επιτυχία.
        <%out.println(" ");%><a href="admin.jsp">Επιστροφή</a>
