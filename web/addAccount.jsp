                ...
                <div class="art-contentLayout">
                    <div class="art-content">
                        ...
                        <div>
                                 ...
                                 <form METHOD=POST ACTION="checkAFMforAccount.jsp" onsubmit='return formValidator()'>
                                    <table border="0" >
                                        <tbody >
                                            <tr>
                                                <td>AΦΜ Πελάτη:</td>
                                                <td><INPUT id='afm' TYPE=TEXT NAME=afm SIZE=20 >(9 χαρακτήρες)<BR></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                ...
                                <form METHOD=POST ACTION="teller.jsp">
