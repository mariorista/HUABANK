                    ...
                    <div class="art-contentLayout">
                        <div class="art-content">
                            ...
                            <div>
                                ...
                                <FORM METHOD=POST ACTION="insertUser.jsp" onsubmit='return formValidator()'>
                                    <table border="0">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><INPUT TYPE=RADIO NAME=typeOfUser VALUE="t"checked>Ταμίας
                                                    <INPUT TYPE=RADIO NAME=typeOfUser VALUE="s">Υπεύθυνος Ταμίων
                                                    <INPUT TYPE=RADIO NAME=typeOfUser VALUE="b">Διευθυντής Τράπεζας</td>
                                            </tr>
                                            <tr>
                                                <td>
